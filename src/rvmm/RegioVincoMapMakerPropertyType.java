...
public enum RegioVincoMapMakerPropertyType {
    ...
    RVMM_NEW_MAP_SELECT_SHAPEFILE_DIALOG_TITLE,
    ...
    RVMM_NEW_MAP_DIALOG_SHAPEFILE_PROMPT_LABEL,
    RVMM_NEW_MAP_DIALOG_SHAPEFILE_LABEL,
    RVMM_NEW_MAP_DIALOG_SHAPEFILE_EDIT_BUTTON,
